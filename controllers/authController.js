...
//Only for rendered pages never an error
exports.isLoggedIn = async (req, res, next)=> {
    if(req.cookies.jwt) {
        try{
            ...
            //check if password has been changed since last token was issued
            if(currentUser.changedPasswordAfter(decoded.iat)) {
                return next();
            }
...
exports.forgotPassword = catchAsync(async(req, res, next)=> {
    ...
    try{
        ...
        // await sendEmail({
        //     email: user.email,
        //     subject: 'Your password token is only valid for 10 minutes',
        //     message
        // });
