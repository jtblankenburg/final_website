...
exports.deleteMe = exports.updateData = void 0;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.status == 204) {
              (0, _alerts.showAlert)('success', 'Account has been deleted successfully');
            }
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('danger', 'Error Deleting Account');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"manageAdmins.js":[function(require,module,exports) {
"use strict";
...
var manageAdmin = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id, data, message, type) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)("".concat(type), message);
              window.setTimeout(function () {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('danger', 'Error with request users');
  ...
  return function manageAdmin(_x, _x2, _x3, _x4) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Success, account created successfully');
              window.setTimeout(function () {
                location.assign('/');
              }, 1000);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateUserHomePage.js":[function(require,module,exports) {
"use strict";
...
var updateHomePage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Home page updated successfully');
              window.setTimeout(function () {
  ...
  return function updateHomePage(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateHomePage = updateHomePage;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"createEvent.js":[function(require,module,exports) {
"use strict";
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Event created successfully');
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateHomePhoto.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateHomePhoto = void 0;
...
var updateHomePhoto = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/homePhoto/".concat(id),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Photo updated successfully');
            }
  ...
  return function updateHomePhoto(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateHomePhoto = updateHomePhoto;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addSpecificEventPhoto.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSpecificEventPhoto = void 0;
...
var addSpecificEventPhoto = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/specificEvents/".concat(id, "/specificEventPhoto"),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Image added successfully');
            }
  ...
  return function addSpecificEventPhoto(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.addSpecificEventPhoto = addSpecificEventPhoto;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteSpecificEventPhoto.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteSpecificEventPhoto = void 0;
...
var deleteSpecificEventPhoto = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/specificEventPhoto/".concat(id)
            });
          ...
          case 3:
            ...
            if (res.status === 'success') {
              (0, _alerts.showAlert)('success', 'Image deleted successfully');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('danger', _context.t0.response.message);
  ...
  return function deleteSpecificEventPhoto(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteSpecificEventPhoto = deleteSpecificEventPhoto;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addSpecificEvent.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addSpecificEvent = void 0;
...
var addSpecificEvent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'POST',
              url: "http://127.0.0.1:3000/api/v1/events/".concat(id, "/specificEvent"),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'specific event added successfully');
            }
  ...
  return function addSpecificEvent(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.addSpecificEvent = addSpecificEvent;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"deleteSpecificEvent.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.deleteSpecificEvent = void 0;
...
var deleteSpecificEvent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/specificEvents/".concat(id)
            });
          ...
          case 3:
            ...
            if (res.status === 'success') {
              (0, _alerts.showAlert)('success', 'Specific Event deleted successfully');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('danger', 'Error deleting specific event try again later');
  ...
  return function deleteSpecificEvent(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.deleteSpecificEvent = deleteSpecificEvent;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'DELETE',
              url: "http://127.0.0.1:3000/api/v1/events/".concat(id)
            });
          ...
          case 3:
            ...
            if (res.status === 'success') {
              (0, _alerts.showAlert)('success', 'Event deleted successfully');
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('danger', 'Error deleting event please try again later');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateAboutPage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateAboutPage = void 0;
...
var updateAboutPage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'About Page updated successfully');
            }
  ...
  return function updateAboutPage(_x) {
    return _ref.apply(this, arguments);
  };
}();
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('danger', 'Error deleting user');
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateRushPage.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateRushPage = void 0;
...
var updateRushPage = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Rush Page updated successfully');
              window.setTimeout(function () {
  ...
  return function updateRushPage(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateRushPage = updateRushPage;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"updateRushPhoto.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateRushPhoto = void 0;
...
var updateRushPhoto = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/rushPhoto/".concat(id),
              data: data
            });
  ...
  return function updateRushPhoto(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateRushPhoto = updateRushPhoto;
...
var _manageAdmins = require("./manageAdmins");

var _signup = require("./signup");

var _updateUserHomePage = require("./updateUserHomePage");

var _createEvent = require("./createEvent");

var _updateHomePhoto = require("./updateHomePhoto");

var _addSpecificEventPhoto = require("./addSpecificEventPhoto");

var _deleteSpecificEventPhoto = require("./deleteSpecificEventPhoto");

var _addSpecificEvent = require("./addSpecificEvent");

var _deleteSpecificEvent = require("./deleteSpecificEvent");

var _deleteEvent = require("./deleteEvent");

var _updateAboutPage = require("./updateAboutPage");

var _deleteUser = require("./deleteUser");

var _updateRushPage = require("./updateRushPage");

var _updateRushPhoto = require("./updateRushPhoto");
...
var userPassForm = document.querySelector('.form-updatePass');
var signupForm = document.querySelector('.sign-up');
var updateHomePageForm = document.querySelector('.edit-home-page');
var addEventForm = document.querySelector('.add-event');
var addSpecificEventForm = document.querySelector('.add-specific-event');
var updateRushPageForm = document.querySelector('.edit-rush-page');
var applyBtn = document.querySelector('.applyForAdmin');
var selectUserOneBtn = document.querySelectorAll('.selectUserOneBtn');
var selectUserTwoBtn = document.querySelectorAll('.selectUserTwoBtn');
var selectUserThreeBtn = document.querySelectorAll('.selectUserThreeBtn');
var selectUserFourBtn = document.querySelectorAll('.selectUserFourBtn');
var selectUserFiveBtn = document.querySelectorAll('.selectUserFiveBtn');
var selectUserSixBtn = document.querySelectorAll('.selectUserSixBtn');
var selectUserSevenBtn = document.querySelectorAll('.selectUserSevenBtn');
var selectUserEightBtn = document.querySelectorAll('.selectUserEightBtn'); //LOGIN AND LOGOUT
...
if (signupForm) signupForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var firstname, lastname, email, major, year, favoritePhrase, pledgeClass, pin, password, passwordConfirm;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            favoritePhrase = document.getElementById('favoritePhrase').value;
            pledgeClass = document.getElementById('pledgeclass').value;
...
if (applyBtn) applyBtn.addEventListener('click', /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(e) {
    var id, applyForAdmin;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            id = document.getElementById('apply').value;
            applyForAdmin = true;
            (0, _updateUser.updateData)({
              applyForAdmin: applyForAdmin
            }, 'apply for admin');
            window.setTimeout(function () {
              location.assign('/me');
            }, 1000);
...
var addSpecificEventPhotosForm = document.querySelector('.add-specific-event-photos');
if (addSpecificEventPhotosForm) addSpecificEventPhotosForm.addEventListener('submit', function (e) {
  var specificEventId = document.getElementById('specificEventId').value;
  var fileInputAddSpecificEventPhoto = document.getElementById('addSpecificEventPhotos');

  for (var x = 0; x < fileInputAddSpecificEventPhoto.files.length; x++) {
    var form = new FormData();
    form.append('name', fileInputAddSpecificEventPhoto.files[x]);
    (0, _addSpecificEventPhoto.addSpecificEventPhoto)(form, specificEventId);
  }
});
var fileInputAddSpecificEventPhoto = document.getElementById('addSpecificEventPhotos');
if (fileInputAddSpecificEventPhoto) fileInputAddSpecificEventPhoto.addEventListener('change', function () {
...
var deleteSpecificEventPhotoBtn = document.querySelectorAll('.removeSpecificEventPhoto');

var _loop = function _loop() {
  var specificEventPhotoId = document.getElementById("specificEventPhotoId".concat(i)).value;
  deleteSpecificEventPhotoBtn[i].addEventListener('click', function () {
    (0, _deleteSpecificEventPhoto.deleteSpecificEventPhoto)(specificEventPhotoId);
  });
};
...
var coverPhotoPreview = document.querySelector('.coverPhotoPreview');
if (coverPhoto) coverPhoto.addEventListener('change', function () {
...
if (addSpecificEventForm) addSpecificEventForm.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  (0, _addSpecificEvent.addSpecificEvent)(form, eventID);
});
var deleteSpecificEventBtn = document.querySelectorAll('.delete-specific-event-button');

var _loop2 = function _loop2() {
  var specificEventId = document.getElementById("specificEvent".concat(i)).value;
  deleteSpecificEventBtn[i].addEventListener('click', function () {
    (0, _deleteSpecificEvent.deleteSpecificEvent)(specificEventId);
  });
};
...
var deleteEventBtn = document.querySelectorAll('.delete-Event');

var _loop3 = function _loop3() {
  var eventId = document.getElementById("event".concat(i)).value;
...
var photoInptOne = document.getElementById('photoOne');
var imageTwo = document.querySelector('.imageTwo');
var photoInptTwo = document.getElementById('photoTwo');
var imageThree = document.querySelector('.imageThree');
var photoInptThree = document.getElementById('photoThree'); //PREVIEW FIRST PHOTO

if (photoInptOne) photoInptOne.addEventListener('change', function () {
  var file = this.files[0];
...
if (photoInptTwo) photoInptTwo.addEventListener('change', function () {
  var file = this.files[0];
...
if (photoInptThree) photoInptThree.addEventListener('change', function () {
  var file = this.files[0];
...
if (addEventForm) addEventForm.addEventListener('submit', /*#__PURE__*/function () {
...
var _loop4 = function _loop4() {
  var userOne = document.getElementById("userOne".concat(i)).value; //User ID assigned to that button area

  var userOneImg = document.getElementById("userOneImg".concat(i)).value; //User Image value

  var userOneName = document.getElementById("userOneName".concat(i)).textContent; //User First and Last name

  var userOneMajor = document.getElementById("userOneMajor".concat(i)).textContent; //User major

  var userOneYear = document.getElementById("userOneYear".concat(i)).textContent; //User year

  var userOneFavPhrase = document.getElementById("userOneFavPhrase".concat(i)).textContent; //User phrase
  ...
  selectUserOneBtn[i].addEventListener('click', function () {
    ...
    imageDisplayOne.setAttribute('src', "/img/users/".concat(userOneImg));
  });
};
...
var _loop5 = function _loop5() {
  var userTwo = document.getElementById("userTwo".concat(i)).value; //User Id is assigned to that button area

  var userTwoImg = document.getElementById("userTwoImg".concat(i)).value;
  var userTwoName = document.getElementById("userTwoName".concat(i)).textContent;
  var userTwoMajor = document.getElementById("userTwoMajor".concat(i)).textContent;
  var userTwoYear = document.getElementById("userTwoYear".concat(i)).textContent;
  var userTwoFavPhrase = document.getElementById("userTwoFavPhrase".concat(i)).textContent;
  selectUserTwoBtn[i].addEventListener('click', function () {
    ...
    imageDisplayTwo.setAttribute('src', "/img/users/".concat(userTwoImg));
  });
};
...
;
var promoteBtn = document.querySelectorAll('.promoteAdmin');
var denyBtn = document.querySelectorAll('.denyAdmin'); //ADMIN FUNCTIONS NEED WORK

var _loop6 = function _loop6() {
  var name = document.getElementById("nameUser".concat(i)).value;
  var id = document.getElementById("user".concat(i)).value;
  var applyForAdmin = false;
  denyBtn[i].addEventListener('click', function () {
    (0, _manageAdmins.manageAdmin)(id, {
      applyForAdmin: applyForAdmin
    }, "User: ".concat(name, " has been denied admin permissions"), 'warning');
    window.setTimeout(function () {
      location.assign('/adminpage');
    }, 1000);
  });
...
var _loop7 = function _loop7() {
  ...
  promoteBtn[i].addEventListener('click', function () {
    (0, _manageAdmins.manageAdmin)(id, {
      role: role,
      applyForAdmin: applyForAdmin
    }, "User: ".concat(name, " has been granted admin permissions"), 'success');
    window.setTimeout(function () {
      location.assign('/adminpage');
    }, 1000);
  });
...
if (updateHomePageForm) updateHomePageForm.addEventListener('submit', function (e) {
  e.preventDefault();

  if (document.getElementById('photoOne').files[0] != undefined) {
    var photoOneId = document.getElementById('photoOneVal').value;
    var form = new FormData();
    form.append('name', document.getElementById('photoOne').files[0]);
    (0, _updateHomePhoto.updateHomePhoto)(form, photoOneId);
  }

  if (document.getElementById('photoTwo').files[0] != undefined) {
    var photoTwoId = document.getElementById('photoTwoVal').value;

    var _form = new FormData();

    _form.append('name', document.getElementById('photoTwo').files[0]);

    (0, _updateHomePhoto.updateHomePhoto)(_form, photoTwoId);
  }

  if (document.getElementById('photoThree').files[0] != undefined) {
    var photoThreeId = document.getElementById('photoThreeVal').value;

    var _form2 = new FormData();

    _form2.append('name', document.getElementById('photoThree').files[0]);

    (0, _updateHomePhoto.updateHomePhoto)(_form2, photoThreeId);
  }

  var rushHeading = document.getElementById('headingOne').value;
  var rushParagraph = document.getElementById('paragraphOne').value;
  var aboutHeading = document.getElementById('headingTwo').value;
  var aboutParagraph = document.getElementById('paragraphTwo').value;
  var userOneTitle = document.getElementById('userOneTitle').value;
  var userTwoTitle = document.getElementById('userTwoTitle').value;

  if (userOneId != null && userTwoId != null) {
    var userOne = userOneId;
    var userTwo = userTwoId;
    (0, _updateUserHomePage.updateHomePage)({
      rushHeading: rushHeading,
      rushParagraph: rushParagraph,
      aboutHeading: aboutHeading,
      aboutParagraph: aboutParagraph,
      userOneTitle: userOneTitle,
      userTwoTitle: userTwoTitle,
      userOne: userOne,
      userTwo: userTwo
    });
  } else if (userOneId != null && userTwoId == null) {
    var _userOne = userOneId;
    (0, _updateUserHomePage.updateHomePage)({
      rushHeading: rushHeading,
      rushParagraph: rushParagraph,
      aboutHeading: aboutHeading,
...
var _loop8 = function _loop8() {
  var userOneSelected = document.getElementById("userOne".concat(i)).value; //User ID assigned to that button area
...
var _loop9 = function _loop9() {
  var userTwoSelected = document.getElementById("userTwo".concat(i)).value; //User ID assigned to that button area

  var userTwoImg = document.getElementById("userTwoImg".concat(i)).value; //User Image value

  var userTwoName = document.getElementById("userTwoName".concat(i)).textContent; //User First and Last name

  var userTwoMajor = document.getElementById("userTwoMajor".concat(i)).textContent; //User major

  var userTwoYear = document.getElementById("userTwoYear".concat(i)).textContent; //User year

  var userTwoFavPhrase = document.getElementById("userTwoFavPhrase".concat(i)).textContent; //User phrase
...
var _loop10 = function _loop10() {
  var userThreeSelected = document.getElementById("userThree".concat(i)).value; //User ID assigned to that button area

  var userThreeImg = document.getElementById("userThreeImg".concat(i)).value; //User Image value

  var userThreeName = document.getElementById("userThreeName".concat(i)).textContent; //User First and Last name

  var userThreeMajor = document.getElementById("userThreeMajor".concat(i)).textContent; //User major

  var userThreeYear = document.getElementById("userThreeYear".concat(i)).textContent; //User year

  var userThreeFavPhrase = document.getElementById("userThreeFavPhrase".concat(i)).textContent; //User phrase
  ...
  selectUserThreeBtn[i].addEventListener('click', function () {
    ...
    imageDisplayThree.setAttribute('src', "/img/users/".concat(userThreeImg));
  });
};
...
var _loop11 = function _loop11() {
  var userFourSelected = document.getElementById("userFour".concat(i)).value; //User ID assigned to that button area

  var userFourImg = document.getElementById("userFourImg".concat(i)).value; //User Image value

  var userFourName = document.getElementById("userFourName".concat(i)).textContent; //User First and Last name

  var userFourMajor = document.getElementById("userFourMajor".concat(i)).textContent; //User major

  var userFourYear = document.getElementById("userFourYear".concat(i)).textContent; //User year

  var userFourFavPhrase = document.getElementById("userFourFavPhrase".concat(i)).textContent; //User phrase
  ...
  selectUserFourBtn[i].addEventListener('click', function () {
    ...
    imageDisplayFour.setAttribute('src', "/img/users/".concat(userFourImg));
  });
};
...
var _loop12 = function _loop12() {
  var userFiveSelected = document.getElementById("userFive".concat(i)).value; //User ID assigned to that button area

  var userFiveImg = document.getElementById("userFiveImg".concat(i)).value; //User Image value

  var userFiveName = document.getElementById("userFiveName".concat(i)).textContent; //User First and Last name

  var userFiveMajor = document.getElementById("userFiveMajor".concat(i)).textContent; //User major

  var userFiveYear = document.getElementById("userFiveYear".concat(i)).textContent; //User year

  var userFiveFavPhrase = document.getElementById("userFiveFavPhrase".concat(i)).textContent; //User phrase
  ...
  selectUserFiveBtn[i].addEventListener('click', function () {
    ...
    imageDisplayFive.setAttribute('src', "/img/users/".concat(userFiveImg));
  });
};
...
var _loop13 = function _loop13() {
  var userSixSelected = document.getElementById("userSix".concat(i)).value; //User ID assigned to that button area

  var userSixImg = document.getElementById("userSixImg".concat(i)).value; //User Image value

  var userSixName = document.getElementById("userSixName".concat(i)).textContent; //User First and Last name

  var userSixMajor = document.getElementById("userSixMajor".concat(i)).textContent; //User major

  var userSixYear = document.getElementById("userSixYear".concat(i)).textContent; //User year

  var userSixFavPhrase = document.getElementById("userSixFavPhrase".concat(i)).textContent; //User phrase
  ...
  selectUserSixBtn[i].addEventListener('click', function () {
    ...
    imageDisplaySix.setAttribute('src', "/img/users/".concat(userSixImg));
  });
};
...
var _loop14 = function _loop14() {
  var userSevenSelected = document.getElementById("userSeven".concat(i)).value; //User ID assigned to that button area

  var userSevenImg = document.getElementById("userSevenImg".concat(i)).value; //User Image value

  var userSevenName = document.getElementById("userSevenName".concat(i)).textContent; //User First and Last name

  var userSevenMajor = document.getElementById("userSevenMajor".concat(i)).textContent; //User major

  var userSevenYear = document.getElementById("userSevenYear".concat(i)).textContent; //User year

  var userSevenFavPhrase = document.getElementById("userSevenFavPhrase".concat(i)).textContent; //User phrase
  ...
  selectUserSevenBtn[i].addEventListener('click', function () {
    ...
    imageDisplaySeven.setAttribute('src', "/img/users/".concat(userSevenImg));
  });
};
...
var _loop15 = function _loop15() {
  var userEightSelected = document.getElementById("userEight".concat(i)).value; //User ID assigned to that button area

  var userEightImg = document.getElementById("userEightImg".concat(i)).value; //User Image value

  var userEightName = document.getElementById("userEightName".concat(i)).textContent; //User First and Last name

  var userEightMajor = document.getElementById("userEightMajor".concat(i)).textContent; //User major

  var userEightYear = document.getElementById("userEightYear".concat(i)).textContent; //User year

  var userEightFavPhrase = document.getElementById("userEightFavPhrase".concat(i)).textContent; //User phrase
  ...
  selectUserEightBtn[i].addEventListener('click', function () {
    ...
    imageDisplayEight.setAttribute('src', "/img/users/".concat(userEightImg));
  });
};
...
;
var updateAboutPageForm = document.querySelector('.edit-about-page');
if (updateAboutPageForm) updateAboutPageForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var userOne = document.getElementById('userOneID').value;
  var userTwo = document.getElementById('userTwoID').value;
  var userThree = document.getElementById('userThreeID').value;
  var userFour = document.getElementById('userFourID').value;
  var userFive = document.getElementById('userFiveID').value;
  var userSix = document.getElementById('userSixID').value;
  var userSeven = document.getElementById('userSevenID').value;
  var userEight = document.getElementById('userEightID').value;
  var headingOne = document.getElementById('headingOne').value;
  var paragraphOne = document.getElementById('paragraphOne').value;
  var headingTwo = document.getElementById('headingTwo').value;
  var userOneTitle = document.getElementById('userOneTitle').value;
  var userTwoTitle = document.getElementById('userTwoTitle').value;
  var userThreeTitle = document.getElementById('userThreeTitle').value;
  var userFourTitle = document.getElementById('userFourTitle').value;
  var userFiveTitle = document.getElementById('userFiveTitle').value;
  var userSixTitle = document.getElementById('userSixTitle').value;
  var userSevenTitle = document.getElementById('userSevenTitle').value;
  var userEightTitle = document.getElementById('userEightTitle').value;
  (0, _updateAboutPage.updateAboutPage)({
    headingOne: headingOne,
    paragraphOne: paragraphOne,
    headingTwo: headingTwo,
    userOneTitle: userOneTitle,
    userTwoTitle: userTwoTitle,
    userThreeTitle: userThreeTitle,
    userFourTitle: userFourTitle,
    userFiveTitle: userFiveTitle,
    userSixTitle: userSixTitle,
    userSevenTitle: userSevenTitle,
    userEightTitle: userEightTitle,
    userOne: userOne,
    userTwo: userTwo,
    userThree: userThree,
    userFour: userFour,
...
var deleteUserBtn = document.querySelectorAll('.deleteUser');

var _loop16 = function _loop16() {
  var userID = document.getElementById("user".concat(i)).value;
  deleteUserBtn[i].addEventListener('click', function () {
    (0, _deleteUser.deleteUser)(userID);
  });
};
...
if (updateRushPageForm) updateRushPageForm.addEventListener('submit', function (e) {
  e.preventDefault();
  ...
  if (document.getElementById('photoOne').files[0] != undefined) {
    ...
    var form = new FormData();
    form.append('name', document.getElementById('photoOne').files[0]);
    (0, _updateRushPhoto.updateRushPhoto)(form, photoOneId);
  }

  if (document.getElementById('photoTwo').files[0] != undefined) {
    var photoTwoId = document.getElementById('photoTwoVal').value;

    var _form3 = new FormData();

    _form3.append('name', document.getElementById('photoTwo').files[0]);

    (0, _updateRushPhoto.updateRushPhoto)(_form3, photoTwoId);
  }

  var headingOne = document.getElementById('headingOne').value;
  var paragraphOne = document.getElementById('paragraphOne').value;
  var paragraphTwo = document.getElementById('paragraphTwo').value;
  var headingTwo = document.getElementById('headingTwo').value;
  var paragraphThree = document.getElementById('paragraphThree').value;
  var ifcURL = document.getElementById('ifcURL').value;
  var headingThree = document.getElementById('headingThree').value;
  (0, _updateRushPage.updateRushPage)({
    headingOne: headingOne,
    paragraphOne: paragraphOne,
